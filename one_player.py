...
class PingPong(object):                               #ping_pong class initialize
    ...
    def update(self, player_paddle, computer_paddle):
        ...
        if self.rect.colliderect(player_paddle.rect):         #this part checks to change the direction of ping_pong if it hits the paddle
            self.direction[0] = -1
...
class ComputerPaddle(object):
    ...
    def update(self, ping_pong):                                       
        if ping_pong.rect.top < self.rect.top:                        #condition for movement of ai paddle by comparing the ping_pong coordinate and the top of the ai paddle
...
class PlayerPaddle(object):
    ...
    def update(self):
        ...
        if self.rect.bottom > self.screensize[1]-1:
            self.centery = self.screensize[1]-50
